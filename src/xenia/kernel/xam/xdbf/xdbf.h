...
enum class SpaID : fourcc_t {
  Xach = make_fourcc("XACH"),
  Xstr = make_fourcc("XSTR"),
  Xstc = make_fourcc("XSTC"),
  Xthd = make_fourcc("XTHD"),
  Title = 0x8000,
};
